                                ...
                                @foreach($orderItems as $item)
                                    <tr>
                                        <td valign="top" style="padding:14px 8px 14px 0; border-bottom:1px solid #e7e5e4;">
                                            <div dir="auto" style="unicode-bidi:plaintext; text-align:start; font-size:15px; line-height:22px; font-weight:bold; color:#292524;">{!! bidi_text($item->display_name) !!}</div>
