...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px; border-bottom: 3px solid #22c55e; padding-bottom: 20px; }
        .header h1 { color: #22c55e; font-size: 32px; margin-bottom: 10px; }
        .logo-container { flex: 1; }
        .invoice-title { flex: 2; text-align: center; }
        ...
        .free-delivery { color: #22c55e; font-weight: bold; }
        .footer { margin-top: 50px; text-align: center; color: #666; font-size: 12px; border-top: 1px solid #ddd; padding-top: 20px; }
        .delivery-note { margin-top: 10px; font-size: 12px; color: #666; }
...
<body style="max-width: 700px">
    ...
    <div class="info-section">
        ...
        <div class="info-box">
            ...
            <p style="margin-top: 10px;"><strong>Date:</strong> {{ $order->created_at->format('d/m/Y H:i') }}</p>
        </div>
    </div>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="text-right">
                    ...
                    @else
                        {{ number_format($order->delivery_fee, 2) }} DH
                    @endif
                </td>
            </tr>
