                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text"
                                           ...
                                           class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 @error('name_ar') border-red-500 ring-2 ring-red-200 @enderror">
                                </div>
                                @error('name_ar')
                                    <div class="flex items-center text-red-600 text-sm mt-1">
                                        <i class="fas fa-exclamation-circle mr-2"></i>
